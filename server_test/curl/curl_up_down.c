...
int main()
{
    FTP_OPT ftp_opt;
    /*
    ftp_opt.url = "ftp://192.168.3.126/srv/ftp/up.txt";
    ftp_opt.user_key = "ftpuser:ftpuser";
    ftp_opt.file = "/home/wy/upload.txt";
...
*/
    ...
    ftp_opt.url = "ftp://192.168.3.126/srv/ftp/download.txt";
    ftp_opt.file = "/home/wy/download.txt";
