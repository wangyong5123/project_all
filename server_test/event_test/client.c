...
int main(int argc, char **argv)
{
  ...
  if (argc != 6) {
    fprintf(stderr, "Usage: client <port> <blocksize> <session> <timeout> <ip>\n");
    return 1;
  }
  ...
  sin.sin_addr.s_addr = inet_addr(argv[5]); /* 127.0.0.1 */
  // inet_addr

  //sin.sin_addr.s_addr = inet_addr("192.168.0.145"); /* 127.0.0.1 */
